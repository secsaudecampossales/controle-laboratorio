              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">123.456.789-00</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">987.654.321-00</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">456.789.123-00</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">Ana Oliveira</div>
                    <div className="text-sm text-gray-500">789.123.456-00</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">176</span> resultados
                </p>
              </div>
              <div>
